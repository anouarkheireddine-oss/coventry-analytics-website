      ...
      <main className="min-h-screen bg-[#f8f7f5] text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          <nav className="flex items-center gap-2 text-xs text-black/30 mb-6">
            ...
            <span>›</span>
            <span className="text-black/60">Contractor vs Permanent</span>
          </nav>
          ...
          <section className="mt-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Contractor vs Permanent — FAQ</h2>
            <div className="space-y-4">
              {FAQS.map(({ q, a }) => (
                <div key={q} className="rounded-xl border border-black/[0.07] bg-black/[0.02] p-4">
