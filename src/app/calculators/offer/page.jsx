    ...
    <main className="min-h-screen bg-[#f8f7f5] text-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-xs text-black/30 mb-6">
          ...
          <span>›</span>
          <Link href="/calculators" className="hover:text-black/60 transition-colors">Calculators</Link>
          <span>›</span>
          <span className="text-black/60">Offer Comparison</span>
        </nav>
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mt-3 mb-2">
            Job Offer Comparison Calculator UK
          </h1>
          <p className="text-black/55 text-[15px] max-w-2xl leading-relaxed">
        ...
        <section className="mt-10 rounded-2xl border border-black/[0.07] bg-black/[0.02] p-6">
          <h2 className="text-lg font-bold text-gray-900 mb-3">How to Evaluate a UK Job Offer</h2>
            ...
            {[
              ...
              <div key={title} className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-black/50 leading-relaxed mt-0.5">{body}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mt-8">
          <h2 className="text-sm font-semibold text-black/40 uppercase tracking-wider mb-3">Related Tools</h2>
