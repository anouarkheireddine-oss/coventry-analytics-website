      ...
      <div className="flex items-center gap-2 mb-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="65,000"
            className="w-full bg-black/[0.03] border border-black/[0.10] rounded-xl pl-8 pr-4 py-3 text-gray-900 font-semibold text-sm placeholder-white/20 focus:outline-none focus:border-[#818cf850] transition-colors"
          />
        </div>
